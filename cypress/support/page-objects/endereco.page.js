class EnderecoPage {
    ...
    editarEnderecoFaturamento(nome, sobrenome, empresa, pais, endereco,
        numero, cidade, estado, cep, telefone, email) {
...
editarEnderecoEntrega(nome, sobrenome, empresa, pais, endereco,
